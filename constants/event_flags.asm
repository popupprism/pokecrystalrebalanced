...
; Johto itemballs
	...
	const EVENT_BURNED_TOWER_B1F_TM_FACADE
...
; Unused: next 48 events
	const EVENT_CHERRYGROVE_CITY_TM_BUBBLEBEAM
	const EVENT_BEAT_RANGER_LOGAN
	const EVENT_BEAT_RANGER_GARTH
	const EVENT_GET_SQUIRTLE
	const EVENT_GET_CHARMANDER
	const EVENT_GET_BULBASAUR
	const EVENT_EVOLUTION_GROVE_TM_VENOSHOCK
	const EVENT_EVOLUTION_GROVE_GREEN_ONIX
	const EVENT_BEAT_PICNICKER_KIKI
	const EVENT_EVOLUTION_GROVE_REPEL
	const EVENT_EVOLUTION_GROVE_RARE_CANDY
	const EVENT_GOT_SLOWPOKETAIL

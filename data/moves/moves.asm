...
; entries correspond to constants/move_constants.asm
	...
	move BIND,         EFFECT_TRAP_TARGET,        70, NORMAL,        75, 20,   0
	move SLAM,         EFFECT_SLAM,               80, NORMAL,        75, 20,   0
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         35, GRASS,        100, 10,   0
	move STOMP,        EFFECT_STOMP,              70, NORMAL,       100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,     100, 30,   0
	move EXTRASENSORY, EFFECT_FLINCH_HIT,         80, PSYCHIC_TYPE,  80, 20,  20
	move JUMP_KICK,    EFFECT_JUMP_KICK,          85, FIGHTING,      95, 25,   0
	move AQUA_JET    , EFFECT_PRIORITY_HIT,       40, WATER,        100, 20,  30
	...
	move POISON_STING, EFFECT_POISON_HIT,         35, POISON,       100, 35,  30
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   25, BUG,          100, 20,  20
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          25, BUG,           85, 20,   0
	...
	move GROWTH,       EFFECT_GROWTH,   	       0, NORMAL,       100, 40,   0
	...
	move ROOST,        EFFECT_HEAL,                0, FLYING,  		100, 15,   0
	...
	move CROSS_POISON, EFFECT_POISON_HIT,         70, POISON,       100, 15,  30
	move HEX,    	   EFFECT_HEX,                65, GHOST,        100, 10,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          75, BUG,          100, 15,   0
	...
	move OVERHEAT,     EFFECT_OVERHEAT,     	 140, FIRE,          90,  5, 100
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        30, FIGHTING,      90, 10,   0
	...
	move CALM_MIND,    EFFECT_CALM_MIND,           0, PSYCHIC_TYPE, 100, 15,   0
	...
	move HEAT_WAVE,    EFFECT_BURN_HIT,          100, FIRE,          90, 10,   0
	...
	move MUD_BOMB,     EFFECT_ACCURACY_DOWN_HIT,  65, GROUND,        85, 10,  30
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL,       100,  5,   0
	move OUTRAGE,      EFFECT_RAMPAGE,           120, DRAGON,       100, 15,   0
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   60, FIGHTING,     100, 15,  50
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        60, WATER,         85, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,         100, 10,   0
	move NASTY_PLOT,   EFFECT_SP_ATK_UP_2,         0, DARK,     	100, 20,   0
	move SKY_UPPERCUT, EFFECT_GUST,		          85, FIGHTING,	     90, 15,   0
	move WILL_O_WISP,  EFFECT_BURN,                0, FIRE,          75, 15,   0
...
; ANIM_OBJ_HEX
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_BLUE, ANIM_GFX_SPEED 
; ANIM_OBJ_BLUE_FLAME
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_11, BATTLEANIMFUNC_MOVE_IN_CIRCLE, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE
; ANIM_OBJ_ROCK_BLAST
	battleanimobj RELATIVE_X | X_FLIP, $b8, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS 	
; ANIM_OBJ_SWEAT
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_67, BATTLEANIMFUNC_DIG, PAL_BATTLE_OB_BLUE, ANIM_GFX_SAND
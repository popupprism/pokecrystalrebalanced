...
SlowpokeClubOutside_Blocks:
	INCBIN "maps/SlowpokeClubOutside.blk"

SlowpokeClub1F_Blocks:
	INCBIN "maps/SlowpokeClub1F.blk"
	
EvolutionGrove_Blocks:
	INCBIN "maps/EvolutionGrove.blk"

...
ENDM
	...
	connection west, SlowpokeClubOutside, SLOWPOKE_CLUB_OUTSIDE, 2
	
	map_attributes SlowpokeClubOutside, SLOWPOKE_CLUB_OUTSIDE, $35, EAST
	...
	map_attributes NationalPark, NATIONAL_PARK, $00, NORTH
	connection north, EvolutionGrove, EVOLUTION_GROVE, 4
	
	map_attributes EvolutionGrove, EVOLUTION_GROVE, $00, SOUTH
	connection south, NationalPark, NATIONAL_PARK, -4
	...
	map_attributes SlowpokeClub1F, SLOWPOKE_CLUB_1F, $00, 0
	map_attributes RangersHouse, RANGERS_HOUSE, $00, 0
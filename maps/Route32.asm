	...
	const ROUTE32_CHARMANDER
	const ROUTE32_COOLTRAINER_F
...
LostCharmanderScript:
	checkevent EVENT_GET_CHARMANDER
	iffalse .Cry
	disappear ROUTE32_CHARMANDER
	end
	
.Cry	
	jumptext CharmanderCryText
	end
	
Route32HelpingCooltrainerFScript:
	faceplayer
	opentext
	checkevent EVENT_GET_CHARMANDER
	iftrue .HowsCharmander
	writetext LostCharmanderText
	waitbutton
	special GetFirstPokemonHappiness
	ifgreater 150 - 1, .GiveCharmander
	closetext
	end
	
.GiveCharmander:
	writetext PokemonLovesYouText
	yesorno
	iffalse .Refused
	...
	writetext ThankYouCharmanderText
	setevent EVENT_GET_CHARMANDER
	waitbutton
	closetext
	end
	
.HowsCharmander:
	writetext CharmanderCheckupText
	waitbutton
	closetext
	end
	
.Refused:
	writetext PoorCharmanderText
	waitbutton
	closetext
	end
	
.NoRoom:
	writetext YouHaveNoRoomCharText
	waitbutton
	closetext
	end
...
LostCharmanderText:
	text "It was a TRAINER"
	line "with red hair."
	
	para "I saw him abandon"
	line "this poor little"
	cont "baby CHARMANDER"
	
	para "right here, saying"
	line "it was too weak."
	
	para "It needs to meet a"
	line "kind-hearted sort"
	cont "of TRAINER..."
	done
	
CharmanderCheckupText:
...
PokemonLovesYouText:
	...
	para "Could I count on"
	line "you to take good" 
	
	para "care of this poor"
	line "CHARMANDER?"
	done
...
ThankYouCharmanderText:
	text "Thank you so much."
	line "I know CHARMANDER"
	
	para "will be safe with"
	line "a kind TRAINER"
	cont "like you."
	done

PoorCharmanderText:
	text "But the poor little"
	line "CHARMANDER..."
	done

YouHaveNoRoomCharText:
...
Route32_MapEvents:
	...
	object_event 13, 52, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 3, LostCharmanderScript, -1
	object_event 12, 52, SPRITE_LASS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route32HelpingCooltrainerFScript, -1

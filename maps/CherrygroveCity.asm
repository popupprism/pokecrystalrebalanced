	...
	const CHERRYGROVECITY_POKE_BALL1
...
CherrygroveCityTMBubblebeam:
	itemball TM_BUBBLEBEAM
...
CherrygroveCity_MapEvents:
	...
	object_event 22, 13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, CherrygroveCityTMBubblebeam, EVENT_CHERRYGROVE_CITY_TM_BUBBLEBEAM

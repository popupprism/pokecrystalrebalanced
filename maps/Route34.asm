...
Route34OfficerFScript:
	faceplayer
	opentext
	checkevent EVENT_GET_SQUIRTLE
	iftrue .HowsSquirtle
	writetext UnrulySquirtleText
	waitbutton
...
.GiveSquirtle:
	writetext BeatWhitneySquirtleText
	yesorno
	iffalse .Refused
	...
	writetext ThankYouSquirtleText
	setevent EVENT_GET_SQUIRTLE
	waitbutton
	closetext
	end
	
.HowsSquirtle:
	writetext SquirtleCheckupText
	waitbutton
	closetext
	end
	
.Refused:
	writetext PoorSquirtleText
	waitbutton
	closetext
	end
	
.NoRoom:
	writetext YouHaveNoRoomSquirText
	waitbutton
	closetext
	end
...
UnrulySquirtleText:
	text "My SQUIRTLE is"
	line "always acting up."
	
	para "It needs a better"
	line "TRAINER than me."
	
	para "If only I were"
	line "good enough to"
	cont "take on WHITNEY."
	done
	
BeatWhitneySquirtleText:
	text "Wait...is that a"
	line "a PLAINBADGE? I'm"
	cont "impressed!"
	...
	para "He needs better"
	line "care than I can"
	cont "give him."
	done
...
ThankYouSquirtleText:
	text "I'm confident that"
	line "SQUIRTLE is in"
	cont "good hands."
	done

SquirtleCheckupText:
	text "How's my old pal"
	line "SQUIRTLE doing?"
	done
...
Route34_MapEvents:
	...
	object_event  6,  9, SPRITE_OFFICER_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route34OfficerFScript, -1

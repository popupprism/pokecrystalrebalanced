...
Route32Pokecenter1FCooltrainerMScript:
	...
	iffalse .Furious
	writetext Route32Pokecenter1FCooltrainerMNormalText
	waitbutton
	closetext
	end
	
.Furious
	writetext Route32Pokecenter1FCooltrainerMText
	waitbutton
	closetext
	end
...
Route32Pokecenter1FCooltrainerMText:
	text "That CHARMANDER on"
	line "the road..."
	
	para "Seeing an abused"
	line "#MON like that"
	
	para "makes me furious,"
	line "but it's still"
	
	para "really loyal to"
	line "its TRAINER for"
	cont "some reason..."
	done
	
Route32Pokecenter1FCooltrainerMNormalText:
	text "TRAINERS who abuse"
	line "their #MON will"
	
	para "never become one"
	line "of the greats."
	done
...
Route32Pokecenter1F_MapEvents:
	...
	object_event  8,  4, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route32Pokecenter1FCooltrainerMScript, -1

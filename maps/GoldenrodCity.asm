...
GoldenrodCityOfficerFScript:
	jumptextfaceplayer GoldenrodCityOfficerFText
...
GoldenrodCityOfficerFText:
	text "I'm worried about"
	line "that new CLUB to"
	
	para "the west of the"
	line "RADIO TOWER."
	
	para "It just seems like"
	line "a shady sort of"
	cont "place to me."
	
	para "Maybe I had better"
	line "investigate..."
	done
...
GoldenrodCity_MapEvents:
	...
	object_event 23, 29, SPRITE_OFFICER_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GoldenrodCityOfficerFScript, EVENT_GOLDENROD_CITY_CIVILIANS
